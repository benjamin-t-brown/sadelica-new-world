...
#define IN_GAME_CMPT_HEADER_HEIGHT_PCT_VERT .1
#define IN_GAME_CMPT_PARTY_MEMBER_STATS_HEIGHT_PCT_VERT .175
#define IN_GAME_CMPT_STATUS_HEIGHT_PCT_VERT .1
#define IN_GAME_CMPT_FOOTER_HEIGHT_PCT_VERT .075
#define IN_GAME_CMPT_INVENTORY_LIST_HEIGHT_PCT_VERT                            \
...
void subRenderPartyMemberIcons(Ui& ui) {}

void subRenderPartyMemberNamePlate(Ui& ui) {}

void subRenderInventoryButton(Ui& ui) {}
...
void renderPartyMemberStatsArea(Ui& ui) {
  auto originalCursorPosition = ImGui::GetCursorPos();
...
void renderInGameCmpt(Ui& ui) {
  ...
  ImGui::Begin("InGame", NULL, window_flags);
