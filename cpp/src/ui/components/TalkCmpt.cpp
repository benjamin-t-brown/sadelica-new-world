...
#define TALK_CMPT_HEADER_HEIGHT_PCT_VERT .2
#define TALK_CMPT_NAMEPLATE_HEIGHT_PCT_VERT .05
#define TALK_CMPT_FOOTER_HEIGHT_PCT_VERT .075
#define TALK_CMPT_TEXT_AREA_HEIGHT_PCT_VERT                                    \
...
void renderTalkCmpt(Ui& ui) {
  ...
  ImGui::Begin("Talk", NULL, window_flags);
