...
/*eslint-disable-line*/ function run(isDryRun) {
  ...
  files[`Alinea_CH_BartoloCaldeburn.json`] = id => {
    ...
    scope.OfySb = () => {
      ...
      let text = `"Watch your tone, or you might find your tongue in a ditch somewhere."  He takes a small sip from his drink, and you notice a wickedly curved blade on a hilt at his hip.`;
      core.say(text, scope.ku2iV);
    };
