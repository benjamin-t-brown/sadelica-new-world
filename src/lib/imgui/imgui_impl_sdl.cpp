...
#endif
    // Setup backend capabilities flags
    // ImGui_ImplSDLRenderer_Data* bd2 = IM_NEW(ImGui_ImplSDLRenderer_Data)();
    // io.BackendRendererUserData = (void*)bd2;
    // io.BackendRendererName = "imgui_impl_sdlrenderer";
    // io.BackendFlags |= ImGuiBackendFlags_RendererHasVtxOffset;  // We can honor the ImDrawCmd::VtxOffset field, allowing for large meshes.
    // bd2->SDLRenderer = renderer;
...
bool ImGui_ImplSDLRenderer_CreateFontsTexture()
{
    ...
    SDL_Log("called GetTexDataAsRGBA32");
...
void ImGui_ImplSDL2_NewFrame() {
  ...
  // ImGui_ImplSDLRenderer_Data* bd2 = ImGui_ImplSDLRenderer_GetBackendData();
  // IM_ASSERT(bd2 != NULL && "Did you call ImGui_ImplSDLRenderer_Init()?");
