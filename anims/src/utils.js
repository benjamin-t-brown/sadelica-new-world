...
const LS_PREFIX = 'anims_ls_';

export const getImageFilter = () => {
  return localStorage.getItem(LS_PREFIX + 'imageFilter') ?? '';
};

export const setImageFilter = n => {
  localStorage.setItem(LS_PREFIX + 'imageFilter', String(n));
};
